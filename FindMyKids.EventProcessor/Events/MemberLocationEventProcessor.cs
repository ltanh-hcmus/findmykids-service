    ...
    public class MemberLocationEventProcessor : IEventProcessor
    {
        ...
        )
        {
            ...
            this.subscriber.MemberLocationRecordedEventReceived += (mlre) => {
                ...
                var memberLocations = locationCache.GetMemberLocations(mlre.FamilyID);
                ...
                locationCache.Put(mlre.FamilyID, new MemberLocation { MemberID = mlre.MemberID, Location = new GpsCoordinate {
